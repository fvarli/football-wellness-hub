...
| Player detail | `/players/[id]` | Profile header, risk profile, wellness + load trend sparklines, latest check-in (editable), body soreness, recent sessions, wellness history |
